...
function About() {
    ...
    function handleBtn(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, index: number) {
        // get previous active btn if any
        const prevActive: HTMLButtonElement | null = document.querySelector(`.${styles['btn-active']}`);
        ...
        <div className={styles.page}>
            ...
            <main className={styles.main}>
                <div className={styles.navbar}>
                    <button onClick={(e) => handleBtn(e, 0)} className={styles['navbar-btn']}>Le projet</button>
                    <button onClick={(e) => handleBtn(e, 1)} className={styles['navbar-btn']}>Notes sur la prononciation</button>
                    <button onClick={(e) => handleBtn(e, 2)} className={styles['navbar-btn']}>Autres</button>
                </div>
