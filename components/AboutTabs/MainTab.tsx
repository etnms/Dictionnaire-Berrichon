...
function MainTab() {
    return (
        <div>
            <section>
                <h1>Le projet</h1>
                <p>Ce projet a pour but de créer un dictionnaire bi-directionel berrichon-français et français-berrichon.</p>
                <p>A travers ce dictionnaire vous pouvez chercher des termes en berrichon et accéder à leurs traductions.
                ...
                <p>Il est important de noter que le berrichon n'a pas d'orthographe officiel. Il est donc possible que l'orthographe de
                ...
                <p>Ce dictionnaire représente ainsi un long travail de dialectologie toujours en évolution.
            ...
            <section>
                <p>Ce dictionnaire est un projet open-source est vous pouvez retrouver le site sur Github: <a>lien github</a> </p>
            </section>
        </div>
    );
}
